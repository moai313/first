...
public class NoticeDao {
	...
	public int selectSearchDateListCount(Search search) {
		return sqlSessionTemplate.selectOne("noticeMapper.selectSearchDateListCount", search);
	}
	
	public ArrayList<Notice> selectSearchTitleList(Search search){
		List<Notice> list = sqlSessionTemplate.selectList("noticeMapper.selectSearchTitleList", search);
		return (ArrayList<Notice>)list;
	}
	
	public ArrayList<Notice> selectSearchContentList(Search search){
		List<Notice> list = sqlSessionTemplate.selectList("noticeMapper.selectSearchContentList", search);
		return (ArrayList<Notice>)list;
	}
	
	public ArrayList<Notice> selectSearchDateList(Search search){
		List<Notice> list = sqlSessionTemplate.selectList("noticeMapper.selectSearchDateList", search);
		return (ArrayList<Notice>)list;
	}
}
