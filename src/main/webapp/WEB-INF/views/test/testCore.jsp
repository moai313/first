...
그래도 출력 : <c:out value="<h2>태그로 출력하기</h2>" escapeXml="true" /> <br>
...
<%-- ${param.전송온이름} == request.getParameter("전송온이름") 과 같음
	실행 테스트시에는 부라우저 주소표시줄에 기존 url 뒤에 직접 입력함 : 
...
<hr>
<%
	java.util.ArrayList<String> bookList = new java.util.ArrayList<>();
	bookList.add("java");
	bookList.add("oracle");
	bookList.add("jdbc");
	bookList.add("html5");
...
<!-- <a href="moveFmt.do?no=123">testFmt 페이지로 이동</a> -->
